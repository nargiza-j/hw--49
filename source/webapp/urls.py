...
from webapp.views import IndexView, TaskView, TaskDeleteView, TaskCreateView, TaskUpdateView, ProjectList, ProjectView, \
    ProjectCreate, ProjectUpdate, ProjectDelete, UsersListView, ChangeUsersInProjectView
...
urlpatterns = [
    ...
    path('project/<int:pk>/change-users/', ChangeUsersInProjectView.as_view(), name="change_project_users"),
